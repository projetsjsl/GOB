...
const GroupChatTab: React.FC<TabProps> = ({ setActiveTab }) => {
    ...
    const handleOpenRobotWebTab = () => {
        if (setActiveTab) {
            setActiveTab('robotweb');
            return;
        }
        window.open(settings.sessionUrl, '_blank', 'noopener,noreferrer');
    };
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex items-center justify-between flex-wrap gap-3">
                    ...
                    <button
                        onClick={handleOpenRobotWebTab}
                        className="px-4 py-2 rounded-lg bg-gray-700 hover:bg-gray-600 border border-gray-600 text-sm"
                    >
                        Basculer vers RobotWeb ↗
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-4 rounded-xl bg-gray-900 border border-gray-700 shadow space-y-3">
                        <div className="flex items-center gap-2 text-xs uppercase tracking-[0.15em] text-blue-200">
                            <span className="px-2 py-1 rounded-md bg-blue-900/50 border border-blue-700/60">RobotWeb</span>
                            <span className="px-2 py-1 rounded-md bg-gray-800 border border-gray-700">Raccourci</span>
                        </div>
                        <div className="flex items-start justify-between gap-3">
                            <div className="space-y-1">
                                <p className="text-sm text-gray-300">Le site RobotWeb est prêt à être ouvert ou prévisualisé directement depuis l’onglet ChatGPT Groupe.</p>
                                <p className="text-xs text-gray-400">Le lien partagé est identique à celui du salon commun pour éviter toute confusion.</p>
                            </div>
                            <button
                                onClick={handleOpenRobotWebTab}
                                className="px-3 py-2 rounded-lg bg-blue-700 hover:bg-blue-600 text-sm font-semibold shadow"
                            >
                                Ouvrir RobotWeb
                            </button>
                        </div>
