        ...
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">
              Guide : Reduire les N/A et Actualiser les Profils
            </h2>
            <p className="text-sm text-gray-600 mt-1">
              Comment reduire le nombre de tickers affichant "N/A" dans le KPI Dashboard
            </p>
          </div>
        </div>
        ...
        <div className="prose prose-sm max-w-none">
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-700">
              Reduire le nombre de tickers affichant "N/A" dans le KPI Dashboard en synchronisant et nettoyant les profils.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              <li><strong>Profils non synchronises</strong> : Pas encore charges depuis l'API FMP
              ...
              <li><strong>Donnees invalides</strong> :
                <ul className="list-circle list-inside ml-4 mt-1 text-sm text-gray-600">
                  <li>Prix actuel invalide (<= 0)</li>
                  <li>EPS = 0 ou invalide</li>
                  <li>Croissance EPS + Yield <= 0.01%</li>
                  <li>Aucune donnee financiere valide</li>
                </ul>
              </li>
              <li><strong>Fonds mutuels</strong> : Maintenant automatiquement filtres</li>
              <li><strong>Tickers obsoletes</strong> : Donnees trop anciennes ou corrompues</li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-4 rounded-r">
              <h4 className="font-bold text-blue-900 mb-2">Option 1 : Synchronisation en Masse (RECOMMANDE)</h4>
              ...
              <div className="mt-3 p-3 bg-white rounded border border-blue-200">
                ...
                <ul className="list-check list-inside space-y-1 text-xs text-blue-800">
                  <li> Cree un snapshot de sauvegarde avant chaque sync</li>
                  <li> Met a jour les donnees depuis FMP</li>
                  <li> Preserve vos modifications manuelles</li>
                  <li> Recalcule les hypotheses automatiquement</li>
                  <li> Detecte et exclut les metriques aberrantes</li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 mb-4 rounded-r">
              <h4 className="font-bold text-green-900 mb-2">Option 2 : Synchronisation avec Criteres</h4>
              <p className="text-green-800 text-sm mb-3">
                <strong>Dans l'onglet KPI :</strong>
              </p>
              <ol className="list-decimal list-inside space-y-2 text-green-800 text-sm ml-2">
                <li>Cliquez sur <strong>"Sync avec criteres"</strong> (bouton bleu)</li>
                <li>Choisissez un critere :
                  <ul className="list-disc list-inside ml-4 mt-1">
                    <li><strong>Tous les tickers</strong> - Synchronise tout</li>
                    <li><strong>Portefeuille (etoiles)</strong> - Uniquement les tickers du portefeuille</li>
                    <li><strong>Watchlist (il)</strong> - Uniquement la watchlist</li>
                    <li><strong>Tickers avec N/A</strong> - Uniquement les tickers problematiques</li>
                    <li><strong>Par secteur</strong> - Un secteur specifique</li>
                  </ul>
                </li>
                <li>Verifiez le resume des tickers selectionnes</li>
            ...
            <div className="bg-orange-50 border-l-4 border-orange-500 p-4 mb-4 rounded-r">
              ...
              <ol className="list-decimal list-inside space-y-2 text-orange-800 text-sm ml-2">
                <li>Selectionnez le ticker dans la sidebar</li>
                <li>Cliquez sur <strong>"Synchroniser"</strong> (bouton avec icone de rafraichissement)</li>
          ...
          <section className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-3"> Processus Recommande</h3>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <ol className="list-decimal list-inside space-y-3 text-gray-700">
                <li>
                  <strong>Nettoyer les Fonds Mutuels (AUTOMATIQUE)</strong>
                  <p className="text-sm text-gray-600 ml-6 mt-1"> Deja fait - Les fonds mutuels sont automatiquement supprimes au chargement</p>
                </li>
                <li>
                ...
                <li>
                  <strong>Verifier les Resultats</strong>
                  <ul className="list-disc list-inside ml-6 mt-1 text-sm text-gray-600">
                    <li>Allez dans l'onglet <strong>"KPI"</strong></li>
                    <li>Verifiez le nombre de N/A restants</li>
                    <li>Les tickers avec N/A apres sync sont probablement :
                      <ul className="list-circle list-inside ml-4 mt-1">
                        <li>Des fonds mutuels non detectes</li>
                        <li>Des tickers avec donnees vraiment invalides</li>
                        <li>Des tickers obsoletes</li>
                      </ul>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul className="list-disc list-inside ml-6 mt-1 text-sm text-gray-600">
                    ...
                    <li>Cliquez sur <strong>"Sync N/A (X)"</strong> pour synchroniser uniquement les tickers problematiques</li>
                  </ul>
                </li>
              </ol>
            </div>
          ...
          {/* Resultats Attendus */}
          <section className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-3"> Resultats Attendus</h3>
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
              <p className="text-green-800 text-sm mb-2">Apres la synchronisation en masse :</p>
              <ul className="list-check list-inside space-y-1 text-green-800 text-sm ml-2">
                <li> Tous les profils valides auront des donnees a jour</li>
                <li> JPEGY calculable pour la plupart des tickers</li>
                <li> Rendements projetes realistes</li>
          ...
          <section className="mb-6">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r">
              <ul className="list-disc list-inside space-y-2 text-yellow-800 text-sm">
                ...
                <li><strong>Sauvegarde automatique</strong> : Un snapshot est cree avant chaque sync</li>
                <li><strong>Preservation des donnees</strong> : Vos modifications manuelles sont preservees</li>
                <li><strong>Fonds mutuels</strong> : Sont automatiquement exclus (ne peuvent pas etre analyses)</li>
              </ul>
            </div>
          </section>
          ...
          {/* Depannage */}
          <section className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-3"> Depannage</h3>
            <div className="space-y-3">
              <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                <h4 className="font-semibold text-red-900 mb-2">Si la synchronisation echoue pour certains tickers :</h4>
                <ul className="list-disc list-inside space-y-1 text-red-800 text-sm ml-2">
                  <li>Verifiez la console pour les messages d'erreur</li>
                  <li>Certains tickers peuvent etre obsoletes ou invalides</li>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r">
                ...
                <ul className="list-disc list-inside space-y-1 text-blue-800 text-sm ml-2">
                  <li>Verifiez que les tickers ne sont pas des fonds mutuels</li>
                  <li>Verifiez que les donnees FMP sont disponibles</li>
                  <li>Certains tickers peuvent necessiter une synchronisation manuelle</li>
                </ul>
              </div>
            </div>
          </section>
