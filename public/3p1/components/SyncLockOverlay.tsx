 ...
 * Bloque toute interaction avec l'interface jusqu'a la fin de la synchronisation
 */
...
export const SyncLockOverlay: React.FC<SyncLockOverlayProps> = ({
  ...
  return (
    <>
      {/* Overlay plein ecran qui bloque toute interaction */}
      <div 
        ...
        onKeyDown={(e) => {
          // Empecher toute navigation au clavier
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {onAbort && (
              <button
                ...
                title="Arreter la synchronisation"
              >
          ...
          <div className="space-y-2 text-sm">
            ...
            {estimatedTimeRemaining > 0 && remaining > 0 && (
              <div className="flex items-center justify-between text-gray-600">
                <span>Temps estime restant:</span>
          ...
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-xs text-yellow-800 text-center">
               L'interface est verrouillee pendant la synchronisation. 
              Veuillez ne pas naviguer ni modifier les donnees.
            </p>
          </div>
        </div>
      </div>
