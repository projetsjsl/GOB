...
import { ArrowTrendingUpIcon, BanknotesIcon, TagIcon, CalendarDaysIcon, PrinterIcon, CloudArrowDownIcon, EyeIcon, StarIcon } from '@heroicons/react/24/outline';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 border-b pb-2">
        ...
        <div className="mt-2 md:mt-0 flex items-center gap-4 text-sm shrink-0">
           ...
           {onFetchData && (
               ...
               >
                   <CloudArrowDownIcon className={`w-4 h-4 ${isLoading ? 'animate-bounce' : ''}`} />
