...
const IntelliStocksTab = ({ isDarkMode }) => {
    ...
    // Refs pour les widgets TradingView additionnels
    ...
    // Charger les widgets TradingView additionnels
    useEffect(() => {
            ...
            <div className="mb-2">
                ...
                <div className="grid grid-cols-12 gap-2">
                    ...
                    <div className="col-span-8 space-y-2">
                        ...
                        {/* Symbol Info Widget */}
                        <ExpandableComponent title="Symbol Info" icon="📊" isDarkMode={isDarkMode}>
                            <div className={`rounded-lg p-2 transition-colors duration-300 ${isDarkMode ? 'bg-neutral-900 border border-neutral-800' : 'bg-white border border-gray-300'}`}>
                        ...
                        <ExpandableComponent title="Analyse Technique" icon="📈" isDarkMode={isDarkMode}>
                            <div className={`rounded-lg p-2 transition-colors duration-300 ${isDarkMode ? 'bg-neutral-900 border border-neutral-800' : 'bg-white border border-gray-300'}`}>
                        ...
                        {/* Financials Widget */}
                        <ExpandableComponent title="États Financiers" icon="💰" isDarkMode={isDarkMode}>
                            <div className={`rounded-lg p-2 transition-colors duration-300 ${isDarkMode ? 'bg-neutral-900 border border-neutral-800' : 'bg-white border border-gray-300'}`}>
                                <div style={{ height: '400px' }}>
