...
export class EmmaClient {
    ...
    /**
     * Load processing mode from Supabase (GLOBAL for all users, synced with emma-config.html)
     * @private
     */
    async _loadModeFromSupabase() {
        try {
            ...
            console.warn('Could not load global mode from Supabase:', err.message);
        }
        // Keep default 'auto' mode if Supabase unavailable
    }
