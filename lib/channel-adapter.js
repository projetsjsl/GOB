...
export function adaptForSMS(text, context = {}) {
  ...
  // 🚨 SUPPRIMER TOUS LES EMOJIS POUR GSM-7 (coût réduit de 2.3x)
  // Convertir Emma emojis en texte
  cleanedText = cleanedText.replace(/👩🏻‍💼/g, 'Emma:');
  cleanedText = cleanedText.replace(/🤖/g, 'Emma:');
  cleanedText = cleanedText.replace(/👩🏻/g, 'Emma');
  ...
  // ✅ RETOUR OPTIMISÉ - Encodage GSM-7 (160 chars/SMS) au lieu de UCS-2 (70 chars/SMS)
  // Réduction du coût de 2.3x grâce à la suppression des emojis complexes
  return cleanedText;
}
