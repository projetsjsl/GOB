...
export async function adaptForEmail(text, context = {}) {
  ...
  for (const [ticker, logoUrl] of logoMap.entries()) {
    ...
    // Remplacer les occurrences du ticker (mais pas dans les URLs ou attributs HTML)
    // Pattern: \b pour word boundary, éviter de remplacer dans les URLs
