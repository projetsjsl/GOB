...
const DEFAULT_MODELS = [
    { provider: 'perplexity', model_id: 'sonar-pro', name: 'Sonar Pro', max_tokens: 2000, temperature: 0.1, enabled: true, realtime: true },
    { provider: 'perplexity', model_id: 'sonar-reasoning-pro', name: 'Sonar Reasoning Pro', max_tokens: 2000, temperature: 0.1, enabled: true, realtime: true },
    { provider: 'google', model_id: 'gemini-2.0-flash-exp', name: 'Gemini 2.0 Flash', max_tokens: 4096, temperature: 0.7, enabled: true, googleSearch: true },
    { provider: 'google', model_id: 'gemini-3-flash-preview', name: 'Gemini 3 Flash', max_tokens: 4096, temperature: 0.7, enabled: true, googleSearch: true },
    ...
    constructor() {
        ...
        this.modelScores = {
            ...
            'gemini-2.0-flash-exp': { 
                ...
                speed: 0.95, 
                cost: 1.0, 
                realtime: 0.8,      // Can use Google Search grounding
                citations: 0.6,
                googleSearch: true 
            },
