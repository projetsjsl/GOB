...
export function registerAllAgents(orchestrator) {
    ...
    orchestrator.registerAgent('tools', toolsAgent);
    orchestrator.registerAgent('research', researchAgent);
    orchestrator.registerAgent('portfolio', portfolioAgent);
    orchestrator.registerAgent('alert', alertAgent);
    orchestrator.registerAgent('scheduler', schedulerAgent);
    orchestrator.registerAgent('cache', cacheAgent);
    orchestrator.registerAgent('supabase', supabaseAgent);
