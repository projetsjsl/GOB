...
export class TickerExtractor {
  ...
  static isNonTickerQuestion(message) {
    ...
    // Si question sur fonds/macro/stratégie/secteur/crypto/commodities/géo/fiscal ET pas de ticker explicite → probablement non-ticker
    if ((hasFundKeyword || hasMacroKeyword || hasStrategyKeyword || hasSectorKeyword || 
         hasCryptoKeyword || hasCommodityKeyword || hasGeopoliticalKeyword || hasTaxKeyword || hasGeneralKeyword)) {
