 ...
 *
 * NOTE: Éviter les modèles Pro (coûteux) - utiliser uniquement Flash (gratuit/low-cost)
 *
 * Ordre de priorité :
 * 1. gemini-2.5-flash (nouveau, performant, gratuit)
 * 2. gemini-2.0-flash-exp (stable, gratuit)
 * 3. gemini-1.5-flash-latest (fallback stable, gratuit)
 */

import { geminiWithRetry } from './gemini-retry.js';

// Configuration des modèles en ordre de priorité (Flash only - no Pro to save costs)
