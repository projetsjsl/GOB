 ...
 * Supporte: "Marc +18193425966", "Sophie (514) 555-1234", "(819) 342-5966 Max"
 *
...
export function parseInvitationCommand(message) {
  ...
  // Extraire le nom (enlever le numéro de téléphone du message)
  // Important: utiliser le numéro NORMALISÉ pour éviter les caractères résiduels
