...
• Structure ta réponse avec sections si > 2 paragraphes`;
     ...
     */
    getSkillsMessage() {
        return `👩🏻 Salut ! Je suis Emma, ton assistante IA financière JSLAI 🚀

📊 MES COMPÉTENCES:

💡 ANALYSES FINANCIÈRES:
1. Analyse complète → "Analyse AAPL"
2. Prix actuel → "Prix MSFT"
3. Actualités → "News GOOGL"
4. Comparaison → "Compare AAPL MSFT"
5. Recommandation → "Recommandation AAPL"

📈 DONNÉES EN TEMPS RÉEL:
6. Indices/Marché → "Indices" ou "Marché"
7. Économie/Taux → "Taux" ou "Fed"
8. Résultats → "Earnings TSLA"
9. Fondamentaux → "Fondamentaux AAPL"
10. Technique → "RSI AAPL"

🎯 OUTILS AVANCÉS:
11. Portfolio → "Ma watchlist"
12. Risque → "Risque NVDA"
13. Secteur → "Secteur tech"
14. Valorisation → "Valorisation AAPL"
15. Screening → "Screening tech"
...
→ Briefing matin (pré-marché)
→ Briefing midi (mi-journée)
→ Briefing soir (post-marché)
...
📱 Écris-moi: 1-438-544-EMMA
🌐 gobapps.com

💼 Propulsé par JSLAI™ - Analyses niveau CFA®`;
    }
