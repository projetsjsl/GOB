...
export class HybridIntentAnalyzer {
    constructor() {
        ...
        this.intentPatterns = {
            ...
            help: {
                keywords: ['aide', 'help', 'comment', 'peux-tu', 'capable', 'fonctionnalités', 'fonctionnalites'],
                confidence: 0.95
            },
            stock_price: {
            ...
            portfolio: {
                keywords: ['portefeuille', 'portfolio', 'watchlist', 'positions', 'titres', 'mes tickers', 'mes titres', 'ma watchlist', 'ma liste', 'mes actions', 'quels tickers', 'quels titres', 'liste de mes', 'show my', 'liste mes', 'affiche mes', 'quelles actions', 'tickers que je suis', 'mes valeurs'],
                confidence: 0.95
            },
            market_overview: {
