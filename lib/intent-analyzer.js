...
export class HybridIntentAnalyzer {
    constructor() {
        // Mapping compagnies → tickers (enrichi avec compagnies majeures)
        ...
        this.intentPatterns = {
            ...
            help: {
                keywords: ['aide', 'help', 'comment', 'peux-tu', 'capable', 'fonctionnalités', 'fonctionnalites', 'que peux-tu faire', 'à quoi sers-tu', 'guide', 'tutoriel', 'documentation', 'explique-moi'],
                confidence: 0.95
            },
            stock_price: {
            ...
            news: {
                keywords: ['actualités', 'actualites', 'nouvelles', 'news', "qu'est-ce qui se passe", 'quoi de neuf', 'dernières infos', 'événements', 'evenements', 'breaking', 'annonces', 'communiqué', 'presse', 'médias', 'headlines', 'titres', 'flash info', 'update'],
                confidence: 0.85
            },
    ...
    _analyzeLocal(userMessage, context) {
        ...
        const intentData = {
            ...
            needs_clarification: false, // ❌ DÉSACTIVÉ - Emma répond toujours directement via LLM
            clarification_questions: [], // ❌ DÉSACTIVÉ - Pas de questions, seulement réponses
