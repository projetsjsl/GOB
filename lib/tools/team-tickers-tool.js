...
export default class TeamTickersTool extends BaseTool {
    ...
    async execute(params, context = {}) {
        try {
            ...
            // Appel à l'API Supabase pour récupérer les tickers d'équipe
            const response = await this.makeApiCall(`${supabaseUrl}/rest/v1/team_tickers?select=*&order=priority.desc,ticker.asc`, {
                headers: {
                    'apikey': supabaseKey,
