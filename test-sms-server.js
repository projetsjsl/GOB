  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <div class="grid" style="margin-top:20px;">
        <div class="stat"><div class="label">Clients</div><div class="value">${stats.totalClients}</div></div>
        <div class="stat"><div class="label">Messages</div><div class="value">${stats.totalMessages}</div></div>
        <div class="stat"><div class="label">Dernier message</div><div class="value" style="font-size:18px;">${stats.lastMessageAt ? new Date(stats.lastMessageAt).toLocaleTimeString('fr-FR') : '—'}</div></div>
    ...
    <div class="card">
      ...
      <form action="/simulate-incoming" method="POST">
        ...
        <div style="display:flex; gap:12px; flex-wrap:wrap;">
          <button type="submit" class="btn-primary">📤 Envoyer à Emma</button>
...
function setNumber(number){document.getElementById('from').value=number;}
