/**
 * Correction finale complète du preheader - réorganiser et corriger l'apostrophe
 */
...
console.log('🔧 Correction finale complète du preheader...\n');
...
if (htmlPartsEnd !== -1) {
  ...
  if (!afterHtmlParts.includes('// Ajouter le preheader')) {
    ...
    // IMPORTANT: Échapper correctement l'apostrophe dans l'apercu
    const preheaderPush = `
...
htmlParts.push('  <div class="container">');`;
    ...
    // Si le preheader push existe déjà, corriger l'apostrophe
    console.log('⚠️  Preheader push() déjà présent, correction de l\'apostrophe...');
    currentCode = currentCode.replace(
...
console.log('\n✅ Correction finale complète du preheader terminée !');
